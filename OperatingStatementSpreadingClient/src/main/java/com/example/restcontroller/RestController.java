...
public class RestController {
	...
	public void writeOSToOutputChannel(@RequestBody OperatingStatement os) {

		Message<OperatingStatement> message = MessageBuilder.withPayload(os).build();
		this.osChannelOut.send(message);
	}
